            ...
            <div id="templatemo_right">
                ...
                <?php } else{?>
                    ...
                    <table width="280" border="0">
                      ...
                      <tr>
                        <td>&nbsp;</td>
                        <td><input type="submit" name="student_login" value="Login" /></td>
                      </tr>
                      <tr>
                        <td colspan="2"><font style="float:right; padding-right:20px;">If you have no account</font><br />
										<a style="float:right; padding-right:20px;" href="?p=st_signup">Create new account</a>		
                                        <a style="float:right; padding-right:20px;" href="?p=recover_account_st">Forgot Password</a></td>
                      </tr>
                    </table>
					</form>
